...
public:
	...
	void bindFrameBufferForDrawing(); // no longer rendering to back buffer, using fbo
	void unbindFrameBuffer(int backBufferWidth, int backBufferHeight); // no longer using fbo, rendering to back buffer
